...
- **Distributed Databases:** Distribute transaction management, Cloud-native databases, geo-distributed databases, 
- **Data Replication and Consistency:** Conflict-free Replicated Data Types (CRDTs), Consensus protocols, Strong and eventual consistency models
- **Vector Data Management:** Distributed vector databases, Advance vector similarity search algorithms (Join and range search), GPU acceleration for vector search
